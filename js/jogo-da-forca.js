let palavras = ["caminhao", "estrada", "carga", "entrega", "europa", "viagem", "volante", "reboque", "quilometros", "direcao", "gps", "jogo", "truck", "simulacao"];
...
function escolheLetra(letra) {
    ...
    if (acertou === false) {
        imagem++;
        document.getElementById("forca").src = "img/jogo-da-forca/forca-"+imagem+".jpg";
